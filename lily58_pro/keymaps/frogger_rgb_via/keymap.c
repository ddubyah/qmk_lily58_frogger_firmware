...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [0] = LAYOUT(
  ...
  KC_TAB,   KC_P,   KC_W,    KC_R,    KC_A,    KC_F,                     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_MINS,
  KC_LCTL,  KC_D,   KC_T,    KC_H,    KC_E,    KC_O,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
  KC_LSFT,  KC_Y,   KC_S,    KC_N,    KC_I,    KC_U, KC_NO,    KC_ENT,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                           KC_NO, OSL(2), MO(4), LT(1,KC_SPC), KC_ENT, MO(2), KC_BSPC, KC_RBRC
),

[1] = LAYOUT(
  _______, KC_6,   KC_7,    KC_8,    KC_9,    KC_0,                     _______, _______, _______, _______, _______, _______,
  KC_F1,   KC_J,   KC_M,    KC_B,    KC_COMM, KC_TAB,                   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
  KC_GRV,  KC_V,   KC_C,    KC_L,    KC_Z,    KC_Q,                     S(KC_GRV), S(KC_0), S(KC_9), S(KC_8), S(KC_7), S(KC_6),
  _______,  KC_X,   KC_G,    KC_K,    KC_APP,  KC_RGUI, KC_NO,  KC_PDOT, S(KC_BSLS), S(KC_RBRC), S(KC_LBRC), S(KC_EQL), S(KC_MINS), KC_RGUI,
                             KC_NO, _______, _______, _______, _______, MO(3), _______, _______
),


[2] = LAYOUT(
  _______, KC_F1,  _______, _______, _______, _______,                  _______, _______, _______, _______, _______, _______,
  KC_GRV,  KC_SCLN, S(KC_SCLN), S(KC_8), S(KC_7), S(KC_SLSH),          KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_NO,
  TG(0),   S(KC_MINS), S(KC_2), KC_MINS, S(KC_1), KC_SLSH,             KC_RGHT, KC_UP,   KC_DOWN, KC_LEFT, KC_NO,   KC_BSLS,
  TG(2),   S(KC_LBRC), KC_LBRC, S(KC_9), S(KC_COMM), S(KC_QUOT), KC_NO, _______, KC_RBRC, KC_LBRC, KC_EQL,  KC_MINS, S(KC_EQL), KC_NO,
                             KC_NO, _______, _______, LT(3,KC_SPC), _______, _______, _______, _______
),

  [3] = LAYOUT(
  KC_NO,   KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,                    KC_NO,   S(KC_3), S(KC_4), KC_EQL,  S(KC_EQL), KC_TAB,
  KC_NO,   S(KC_3), S(KC_4), KC_EQL,  S(KC_EQL), KC_TAB,               KC_NO,   S(KC_6), S(KC_GRV), S(KC_BSLS), S(KC_5), KC_BSLS,
  KC_NO,   S(KC_6), S(KC_GRV), S(KC_BSLS), S(KC_5), KC_BSLS,          KC_NO,   S(KC_RBRC), KC_RBRC, S(KC_0), S(KC_DOT), KC_GRV,
  KC_NO,   S(KC_RBRC), KC_RBRC, S(KC_0), S(KC_DOT), KC_GRV, KC_NO, _______, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                             KC_NO, _______, _______, _______, _______, MO(4), _______, KC_NO
  ),
